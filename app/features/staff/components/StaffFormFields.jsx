    ...
    <>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="space-y-2">
          ...
          <Select value={draft.role} onValueChange={(value) => onFieldChange("role", value)}>
            <SelectTrigger className="w-full" id="staff-role">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              {STAFF_ROLE_OPTIONS.filter((role) => role !== "店主").map((role) => (
        ...
        <div className="space-y-2">
          ...
          <Select value={draft.status} onValueChange={(value) => onFieldChange("status", value)}>
