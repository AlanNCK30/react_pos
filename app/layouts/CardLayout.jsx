...
function MenuItemCardLayout({ imagePath, name, price, callback }) {
  return (
      <button
          className="group flex flex-col bg-destructive rounded-3xl overflow-hidden transition-all hover:shadow-md active:scale-95 text-left cursor-pointer h-85 bg-linear-to-b shadow-[0_10px_10px_rgba(0,0,0,0.5),0_0_20px_rgba(99,102,241,0.05)]  ring-ring border border-primary-foreground"
          onClick={callback}
      >
      ...
      <div className="relative group bg-white border border-slate-200 rounded-xl p-3 shadow-sm hover:border-red-300 transition-all mb-3 mx-2">
          <div className="flex justify-between items-start mb-2">
              <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold text-xl text-gray-800 truncate max-w-30">
                      {drink.name}
                  </h3>
              </div>
          ...
          <div className="flex justify-between items-center mt-4">
              ...
              <div className="flex items-center bg-slate-100 rounded-lg p-1 gap-3 mb-1">
                  ...
                  <span className="text-xl text-black font-bold w-4 text-center">
                      {drink.quantity}
                  </span>
                  <button
                      onClick={() => onUpdateQty(drink.instanceId, 1)}
