...
import drink from "../assets/product_img.jpeg";
    ...
    <div className="flex flex-col h-215 overflow-hidden bg-slate-50">
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in duration-200">
            ...
            <div className="p-6 bg-white border-t border-slate-100">
              <div className="flex justify-between items-center mb-6">
                <span className="text-slate-500/95 font-medium tracking-widest">應付金額</span>
                <span className="text-3xl font-black text-slate-800/95">$ {grandTotal}</span>
              </div>
              ...
              <div className="space-y-2 mb-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  >
                    ...
                    <span className="text-md opacity-70">${activeDrink.medium}</span>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <span className="text-md opacity-70">${activeDrink.large}</span>
                  </button>
                </div>
              </div>
              <div className="space-y-2 mb-4">
                  ...
                  {menuData.optionGroups[activeDrink.opt_group_id]?.add_ons.map((addon) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-base text-slate-600 opacity-60">+${addon.price}</span>
                      </button>
                    );
                  })}
                </div>
      ...
      <div className="flex flex-1 overflow-hidden bg-background/5 gap-2 px-2">
        <div className="flex flex-col flex-3 h-full rounded-xl shadow-xl border border-background shadow-muted bg-primary/85 ring-slate-500 mt-2 ">
          <div className="flex justify-between items-center my-auto  mb-2 px-2 py-2 bg-primary  border-t border-background/85 ring-1 ring-background/80 shadow-[0_10px_50px_rgba(0,0,0,0.5),0_0_20px_rgba(99,102,241,0.05)] rounded-t-xl ">
            <div className="text-2xl font-bold text-white tracking-widest ">{displayTitle}</div>
        ...
        <div className="flex-1 flex flex-col h-full rounded-xl shadow-xl border border-background shadow-muted bg-primary/85 ring-slate-500 mt-2">
          <div className="my-auto px-2 py-2 bg-primary/85 border-b border-white/85 ring-1 ring-white/80 shadow-[0_10px_50px_rgba(0,0,0,0.5),0_0_20px_rgba(99,102,241,0.05)] rounded-t-xl ">
            <h2 className="text-2xl font-bold text-white/90 tracking-widest">目前訂單</h2>
          </div>
          ...
          <div className="p-4 bg-primary/10 border-t-2 border-muted/80 space-y-3">
            <div className="flex justify-between text-lg font-bold text-primary-foreground">
              <span className="text-base  font-normal tracking-wide text-muted">總計</span>
              <span className="text-xl tracking-wide text-muted font-normal ">$ {grandTotal}</span>
            </div>
            <button
